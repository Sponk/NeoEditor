...
#ifndef __TEXTURES_ANIM
#define __TEXTURES_ANIM

namespace Neo
{
class NEO_ENGINE_EXPORT TexturesAnim
{
public:
...
public:
	...
	inline TextureAnim * getTexturesAnim(void){ return m_texturesAnim; }
};
}
#endif
