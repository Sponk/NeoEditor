...
// FIXME: UGLY!
using namespace Neo;
class GL4Context : public Neo::RenderingContext
{
private:
        // version
...
public:
        ...
        void deleteShader(unsigned int * shaderId, unsigned int program = 0);
	...
	void selectSubroutine(unsigned int fx, unsigned int type, const char* routine);
