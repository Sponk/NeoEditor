...
class NEO_CORE_EXPORT RenderingContextDummy : public RenderingContext
{
public:
	...
	virtual void texImage(unsigned int level, unsigned int width, unsigned int height, VAR_TYPES type, TEX_MODES mode, const void * pixels) {}
	virtual void texSubImage(unsigned int level, int xoffset, int yoffset, unsigned int width, unsigned int height, VAR_TYPES type, TEX_MODES mode, const void * pixels) {}
	virtual void generateMipMap(void) {}
	virtual void getTexImage(unsigned int level, Image * image){}

	virtual void createFrameBuffer(unsigned int * frameBufferId) {}
	virtual void deleteFrameBuffer(unsigned int * frameBufferId) {}
	virtual void bindFrameBuffer(unsigned int frameBufferId) {}
	virtual void getCurrentFrameBuffer(unsigned int * frameBufferId) {}
	virtual void attachFrameBufferTexture(FRAME_BUFFER_ATTACHMENT attachment, unsigned int textureId) {}
	virtual void attachFrameBufferRB(FRAME_BUFFER_ATTACHMENT attachment, unsigned int renderBufferId){}
	virtual void setDrawingBuffers(FRAME_BUFFER_ATTACHMENT * buffers, unsigned int size) {}
	...
	virtual void updateFX(unsigned int fxId) {}
	virtual void deleteFX(unsigned int * fxId) {}
	virtual void sendUniformInt(unsigned int fxId, const char * name, int * values, const int count = 1) {}
	virtual void sendUniformFloat(unsigned int fxId, const char * name, float * value, const int count = 1) {}
	virtual void sendUniformVec2(unsigned int fxId, const char * name, float * values, const int count = 1) {}
	virtual void sendUniformVec3(unsigned int fxId, const char * name, float * values, const int count = 1) {}
	virtual void sendUniformVec4(unsigned int fxId, const char * name, float * values, const int count = 1) {}
	virtual void sendUniformMatrix(unsigned int fxId, const char * name, Matrix4x4 * matrix, const int count = 1, const bool transpose = false) {}
	virtual void getAttribLocation(unsigned int fxId, const char * name, int * location) {}
	...
	virtual void setVertexPointer(VAR_TYPES type, unsigned int components, const void * pointer) {}
	virtual void setColorPointer(VAR_TYPES type, unsigned int components, const void * pointer) {}
	virtual void setNormalPointer(VAR_TYPES type, const void * pointer) {}
	virtual void setTexCoordPointer(VAR_TYPES type, unsigned int components, const void * pointer) {}
	virtual void setAttribPointer(unsigned int location, VAR_TYPES type, unsigned int components, const void * pointer, const bool normalized = false) {}

	virtual void drawArray(PRIMITIVE_TYPES type, unsigned int begin, unsigned int size) {}
	virtual void drawElement(PRIMITIVE_TYPES type, unsigned int size, VAR_TYPES indicesType, const void * indices) {}

	virtual void enableLineAntialiasing(void) {}
	virtual void disableLineAntialiasing(void) {}

	virtual void setMaterialDiffuse(const Vector4 & diffuse) {}
	virtual void setMaterialSpecular(const Vector4 & specular) {}
	virtual void setMaterialAmbient(const Vector4 & ambient) {}
	virtual void setMaterialEmit(const Vector4 & emit) {}
	virtual void setMaterialShininess(float shininess) {}

	virtual void enableScissorTest(void) {}
	virtual void disableScissorTest(void) {}
	virtual void setScissor(int x, int y, unsigned int width, unsigned int height) {}

	virtual void setColor(const Color & color) {}
	virtual void setColor3(const Vector3 & color) {}
	virtual void setColor4(const Vector4 & color) {}
	...
	virtual void enablePolygonOffset(float x, float y) {}
	...
	virtual void getModelViewMatrix(Matrix4x4 * matrix) {}
	virtual void getProjectionMatrix(Matrix4x4 * matrix) {}
	virtual void getTextureMatrix(Matrix4x4 * matrix) {}

	virtual void enableFog(void) {}
	virtual void disableFog(void) {}
	virtual void setFogColor(const Vector3 & color) {}
	virtual void setFogDistance(float min, float max) {}
	virtual void getFogColor(Vector3 * color) {}
	virtual void getFogDistance(float * min, float * max) {}

	virtual void enableLighting(void) {}
	virtual void disableLighting(void) {}
	virtual void enableLight(unsigned int id) {}
	virtual void disableLight(unsigned int id) {}
	virtual void setLightPosition(unsigned int id, const Vector4 & position) {}
	virtual void setLightDiffuse(unsigned int id, const Vector4 & diffuse) {}
	virtual void setLightSpecular(unsigned int id, const Vector4 & specular) {}
	virtual void setLightAmbient(unsigned int id, const Vector4 & ambient) {}
	virtual void setLightAttenuation(unsigned int id, float constant, float linear, float quadratic) {}
	virtual void setLightSpotDirection(unsigned int id, const Vector3 & direction) {}
	virtual void setLightSpotAngle(unsigned int id, float angle) {}
	virtual void setLightSpotExponent(unsigned int id, float exponent) {}
	virtual void getLightPosition(unsigned int id, Vector4 * position) {}
	virtual void getLightDiffuse(unsigned int id, Vector4 * diffuse) {}
	virtual void getLightSpecular(unsigned int id, Vector4 * specular) {}
	virtual void getLightAmbient(unsigned int id, Vector4 * ambient) {}
	virtual void getLightAttenuation(unsigned int id, float * constant, float * linear, float * quadratic) {}
	virtual void getLightSpotDirection(unsigned int id, Vector3 * direction) {}
	virtual void getLightSpotAngle(unsigned int id, float * angle) {}
	virtual void getLightSpotExponent(unsigned int id, float * exponent) {}
