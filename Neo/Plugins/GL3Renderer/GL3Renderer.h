...
#ifndef __GL3_RENDERER_H
#define __GL3_RENDERER_H
...
public:
	...
	void initialize();
	void destroy();
	static Renderer* getNew(void) { return new GL3Renderer(); }

	static const char * getStaticName(void){ return "GL3Renderer"; }
