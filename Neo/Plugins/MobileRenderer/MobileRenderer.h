...
public:
	...
	void drawTexturedQuad(const Vector2& position, const Vector2& size,
						  int texture, float rotation, const Vector2& scale,
						  const Vector2& flip, const Vector4& texcoords);
	...
	void drawTexturedQuad(const Vector2& position, const Vector2& size,
						  int texture, float rotation);

	void drawColoredQuad(const Vector2& position, const Vector2& size,
						 const Vector4& color, float rotation);

	void initialize();
	void drawEntity(OEntity*, OCamera*) {}
