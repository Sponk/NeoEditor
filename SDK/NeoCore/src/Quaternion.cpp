...
void Quaternion::setFromAngles(float xAngle, float yAngle, float zAngle)
{
...
void Quaternion::slerp(const Quaternion & q1, const Quaternion & q2, float interpolation)
{
	Quaternion q3;
...
void Quaternion::setFromAngleAxis(float angle, const Vector3 & axis)
{
	const Vector3 normAxis = axis.getNormalized();
...
void Quaternion::setFromVectors(const Vector3 & source, const Vector3 & destination)
{
	Vector3 axis=source.crossProduct(destination);
