...
static swig_lua_method swig_Neo_DataLoadFunction_methods[] = {
    {0,0}
};
static swig_lua_attribute swig_Neo_DataLoadFunction_attributes[] = {
    { "m_functionPtr", _wrap_DataLoadFunction_m_functionPtr_get, _wrap_DataLoadFunction_m_functionPtr_set},
    {0,0,0}
};
static swig_lua_attribute swig_Neo_DataLoadFunction_cls_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_Neo_DataLoadFunction_cls_methods[] = {
    {0,0}
};
static swig_lua_const_info swig_Neo_DataLoadFunction_cls_constants[] = {
    {0,0,0,0,0,0}
};
static swig_lua_class *swig_Neo_DataLoadFunction_bases[] = {0};
static const char *swig_Neo_DataLoadFunction_base_names[] = {0};
static swig_lua_class _wrap_class_Neo_DataLoadFunction = { "DataLoadFunction", &SWIGTYPE_p_Neo__DataLoadFunction,_wrap_new_DataLoadFunction, swig_delete_DataLoadFunction, swig_Neo_DataLoadFunction_methods, swig_Neo_DataLoadFunction_attributes, { "DataLoadFunction", swig_Neo_DataLoadFunction_cls_methods, swig_Neo_DataLoadFunction_cls_attributes, swig_Neo_DataLoadFunction_cls_constants }, swig_Neo_DataLoadFunction_bases, swig_Neo_DataLoadFunction_base_names };
...
static swig_lua_method swig_Neo_DataLoader_methods[] = {
    {"clear", _wrap_DataLoader_clear}, 
    {"addLoader", _wrap_DataLoader_addLoader}, 
    {"loadData", _wrap_DataLoader_loadData}, 
    {0,0}
};
static swig_lua_attribute swig_Neo_DataLoader_attributes[] = {
    {0,0,0}
};
static swig_lua_attribute swig_Neo_DataLoader_cls_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_Neo_DataLoader_cls_methods[] = {
    {0,0}
};
static swig_lua_const_info swig_Neo_DataLoader_cls_constants[] = {
    {0,0,0,0,0,0}
};
static swig_lua_class *swig_Neo_DataLoader_bases[] = {0};
static const char *swig_Neo_DataLoader_base_names[] = {0};
static swig_lua_class _wrap_class_Neo_DataLoader = { "DataLoader", &SWIGTYPE_p_Neo__DataLoader,_wrap_new_DataLoader, swig_delete_DataLoader, swig_Neo_DataLoader_methods, swig_Neo_DataLoader_attributes, { "DataLoader", swig_Neo_DataLoader_cls_methods, swig_Neo_DataLoader_cls_attributes, swig_Neo_DataLoader_cls_constants }, swig_Neo_DataLoader_bases, swig_Neo_DataLoader_base_names };
...
static swig_type_info _swigt__p_Neo__DataLoadFunction = {"_p_Neo__DataLoadFunction", "Neo::DataLoadFunction *", 0, 0, (void*)&_wrap_class_Neo_DataLoadFunction, 0};
static swig_type_info _swigt__p_Neo__DataLoader = {"_p_Neo__DataLoader", "Neo::DataLoader *", 0, 0, (void*)&_wrap_class_Neo_DataLoader, 0};
