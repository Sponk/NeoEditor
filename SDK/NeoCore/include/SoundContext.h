...
class NEO_CORE_EXPORT SoundContextDummy : public SoundContext
{
public:

	// destructor
	virtual ~SoundContextDummy(void){}

	// init context
	virtual void initContext(void) {}

	// buffer
	virtual void createBuffer(unsigned int * bufferId) {}
	...
	virtual void deleteSource(unsigned int * sourceId) {}

	virtual void enableSourceLoop(unsigned int sourceId) {}
	virtual void disableSourceLoop(unsigned int sourceId) {}

	virtual void setSourceRelative(unsigned int sourceId, bool relative) {}

	virtual void setSourceBufferId(unsigned int sourceId, unsigned int bufferId) {}
	virtual void setSourcePosition(unsigned int sourceId, const Vector3 & position) {}
	virtual void setSourceRadius(unsigned int sourceId, float radius) {}
	virtual void setSourcePitch(unsigned int sourceId, float pitch) {}
	virtual void setSourceGain(unsigned int sourceId, float gain) {}
