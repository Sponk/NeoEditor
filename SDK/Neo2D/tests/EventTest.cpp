...
{
public:
	TestEvent(weak_ptr<Neo2D::Gui::Widget> p, std::function<void(Neo2D::Gui::Widget&, const Event&, void*)> cb, void* d) :
		Event(p, cb, d) {}
...
TEST(EventTest, MouseOverTest_false)
{
	...
	auto widget = make_shared<Neo2D::Gui::Widget>(0, 0, 3, 3, nullptr, nullptr);
...
TEST(EventTest, MouseOverTest_true)
{
	...
	auto widget = make_shared<Neo2D::Gui::Widget>(0, 0, 15, 15, nullptr, nullptr);
	shared_ptr<Neo2D::Gui::Event> event = make_shared<Neo2D::Gui::MouseOverEvent>(widget, [](Neo2D::Gui::Widget& w, const Neo2D::Gui::Event&, void* f) { (*((int*)f))++; }, &callbackCalled);
